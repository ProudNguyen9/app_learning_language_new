...
class CreateListeningLessonScreen extends StatefulWidget {
  const CreateListeningLessonScreen({super.key, this.initialLesson});

  final ListeningLesson? initialLesson;

  bool get isEditMode => initialLesson != null;

  @override
  State<CreateListeningLessonScreen> createState() =>
      _CreateListeningLessonScreenState();
}

class _CreateListeningLessonScreenState
    extends State<CreateListeningLessonScreen> {
  ...
  Future<void> _generateWithAi() async {
    ...
    final provider = context.read<ListeningLessonProvider>();
    ...
    try {
      ...
      _showMessage(
        message: 'Đã tạo nội dung nghe bằng AI, bấm lưu để dùng bài luyện.',
        isSuccess: true,
      );
    } catch (e) {
      if (!mounted) return;
      _showMessage(
        message: 'Không thể tạo bài nghe bằng AI: $e',
        isSuccess: false,
      );
    } finally {
      if (mounted) {
            ...
            'messages': [
              {
                'role': 'system',
                'content':
                    'Bạn là trợ lý tạo bài luyện nghe cho app học ngoại ngữ. '
  ...
  Map<String, String> _extractLessonPayload(String rawContent) {
    ...
    if (content.isEmpty) {
      throw const FormatException('AI trả về thiếu nội dung bài nghe');
    }
  ...
  Future<void> _saveLesson() async {
    final lessonProvider = context.read<ListeningLessonProvider>();
    final result =
        widget.isEditMode
  ...
  Widget build(BuildContext context) {
    final provider = context.watch<ListeningLessonProvider>();
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      widget.isEditMode
                          ? 'Chỉnh lại nội dung bài nghe rồi bấm lưu để cập nhật ngay trong danh sách.'
                    ...
                    Text(
                      widget.isEditMode
                          ? 'Bạn có thể đổi tiêu đề, mức độ, nội dung hoặc tạo lại bằng AI trước khi cập nhật bài nghe.'
                          : 'Không còn tự động lưu. Bạn có thể tạo nhanh bằng AI hoặc tự nhập tay toàn bộ nội dung bài nghe.',
                      style: GoogleFonts.plusJakartaSans(
                        fontSize: 12,
                        height: 1.5,
              ...
              _InputCard(
                child: TextFormField(
                  ...
                  decoration: _inputDecoration(
                    hintText: 'Ví dụ: Hội thoại ở sân bay',
              ...
              if (_useAi) ...[
                _SectionLabel(
                  ...
                  title: 'Chủ đề cho AI',
                  subtitle:
                      'Nhập chủ đề để AI tạo bài nghe gần đúng mong muốn.',
                ),
                const Gap(10),
                _InputCard(
                  child: TextFormField(
                    ...
                    decoration: _inputDecoration(
                      hintText: 'Ví dụ: du lịch, trường học, công việc',
              ...
              _SectionLabel(
                ...
                title: 'Nội dung bài nghe',
                subtitle:
                    'Mỗi câu nên ngắn gọn, rõ ràng để người dùng nghe từng câu rồi nhập lại.',
              ),
              const Gap(10),
              _InputCard(
                child: TextFormField(
                  ...
                  decoration: _inputDecoration(
                    hintText:
                        'Nhập đoạn hội thoại hoặc đoạn văn ngắn để luyện nghe - chép chính tả.',
                    ...
                    Expanded(
                      child: Text(
                        _useAi
                            ...
                            : 'Bạn có thể nhập tay toàn bộ bài nghe rồi bấm lưu để xuất hiện trong danh sách bài luyện.',
                        style: GoogleFonts.plusJakartaSans(
                          fontSize: 12,
                          height: 1.45,
                          fontWeight: FontWeight.w500,
